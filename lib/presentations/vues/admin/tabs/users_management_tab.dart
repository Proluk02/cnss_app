        ...
        Expanded(
          child: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              ...
              // CORRECTION : Utilisation de `fromFirestore`
...
class _UserCard extends StatelessWidget {
  ...
  void _showChangeRoleDialog(
      BuildContext context, String uid, String nom, String roleActuel) {
    const roles = [
      'employeur',
      'chefSES',
      'préposé',
  ...
  @override
  Widget build(BuildContext context) {
    // CORRECTION : Gestion des valeurs nulles avec `??` pour l'affichage
    final nom = user.nom ?? "Nom non défini";
    final email = user.email ?? "Email non défini";
    final roleActuel = user.role ?? "N/A";
        ...
        trailing: Row(
          ...
          children: [
            ...
            PopupMenuButton<String>(
              onSelected: (value) {
                if (value == 'edit')
                  _showChangeRoleDialog(context, user.uid, nom, roleActuel);
                else if (value == 'delete')
                  _confirmDelete(context, user.uid, nom);
              },
              itemBuilder: (context) => [
                const PopupMenuItem(
                    value: 'edit', child: Text("Modifier le rôle")),
                const PopupMenuItem(
                    value: 'delete',
